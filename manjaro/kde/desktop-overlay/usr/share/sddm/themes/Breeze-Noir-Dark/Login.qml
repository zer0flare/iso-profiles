    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "#001d2c"
            selectedTextColor: "#a1b4ba"        // The highlighted text color
            selectionColor: "#a1b4ba"           // The text highlight color
            placeholderTextColor:"#a1b4ba"      // When the text field is empty
            background: Rectangle {
                color: "#a1b4ba"
                radius: 2
                                                    //focus   //normal
                border.color: control.activeFocus ? "#a1b4ba" : "#a1b4ba"
                border.width: 1
                implicitWidth: 100
                implicitHeight: 30
            }
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            ...
            background: Rectangle {
                ...
                radius: 2
                                                    //focus   //normal
                border.color: control.activeFocus ? "#001d2c" : "#001d2c"
                border.width: 1
                implicitWidth: 100
                implicitHeight: 30
            }
        ...
        style: ButtonStyle {
            background: Rectangle {
                ...
                gradient: Gradient {                                      //pressed   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "#002a40" : "#001d2c" }
                    GradientStop { position: 1 ; color: control.pressed ? "#002a40" : "#001d2c" }
                }
                //implicitWidth: 100
                implicitHeight: 30
            }
